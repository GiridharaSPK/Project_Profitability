    ...
    <body>
        ...
        <?php
            if(isset($_POST["submit"]))
            {
                ...
                if($npwd == $rnpwd)
                {
                    $updatepwd = mysql_query("insert into passwordrequest(EmployeeID,ExistingPassword,RequestedPassword) values('".$_SESSION['user']."','".$epwd."','".$npwd."')");
                    
//                    $updatepwd = mysql_query("update loginaccess set password = '$npwd' where username = '".$_SESSION['usname']."';");
                    ?>
                    <script type = "text/javascript">alert("Request sent Successfully.");alert("You will be informed once your password is changed.");location.href = "logout.php"</script>
                    <?php
                }
            }
        ?>
            ...
            <center>
                <form name = "pwdform" method = "post" onsubmit = "pwdvalidate();">
                    <table>
                        ...
                        <tr></tr>
                        <tr>
                            <td align = "center"><button class = "btnSubmit" type = "submit" name = "submit">Request for Password Change</button>
                                <style type = "text/css">
                                    .btnSubmit
                                    {
                                        color: #FF0000;
