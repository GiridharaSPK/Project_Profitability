    ...
    <body>
        ...
        <?php
            ...
            if(isset($_POST["submit"]))
            {
                $ename = $_POST['empname'];
                $eid = $_POST['empid'];
                $delque = mysql_query("DELETE FROM loginaccess WHERE username = '$eid';");
        ...
        <fieldset>
            <div align = "center">
                <font class = "t" color = "#FF0000" size = "5">Remove a Member</font>
            </div>
            <div align = "right">
                <table>
                    <tr>
            ...
            <form name = "addform" method="post" action = "removemember.php" onsubmit = "check();" autocomplete="off">
            <center>
                <table>
