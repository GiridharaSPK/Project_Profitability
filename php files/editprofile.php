                    ...
                    <form name = "proform" method = "post" action = "">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class = "main"><input type = "text" name = "email" id = "email"> @TechMahindra.com</td>
                            </tr>
                            <tr>
                                <td class = "main"></td>
...
<?php
    if(isset($_POST["submit"]))
    {
        ...
        $updateque = mysql_query("insert into profilerequest(EmployeeID,FullName,LastName,Band,Code,Mobile,Extension,Email) values('".$_SESSION['user']."','$fname','$lname','$band','$telecode','$mnum','$ext','$mail')");
        ...
        switch($_SESSION['rname'])
        {
            ...
            case 'Admin': ?><script>location.href = "dashboardadmin.php"</script><?php
        }
    }
?>