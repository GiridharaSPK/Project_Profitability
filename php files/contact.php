<html>
    ...
    <body>
        ...
        <div align = "right"><img src = "images/question.png" align = "top">&thinsp;<a href="help.php" target = "_blank" style = "color:#000000; text-decoration:none" onMouseOver = "this.style.color = '#FF0000'" onMouseOut = "this.style.color = '#000000'">Help</a></div>
        <hr><br><br><br>
    </body>
</html>